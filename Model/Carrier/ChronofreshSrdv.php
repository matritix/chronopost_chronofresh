...
class chronofreshSrdv extends AbstractChronopost
{
    /**
     * @var string
     */
    protected $_code = 'chronofreshsrdv';

    const PRODUCT_CODE = '2E';
    const CARRIER_CODE = 'chronofreshsrdv';
    ...
    public function getMethodTitle() {
        ...
        if($this->_checkoutSession->getData('chronopostsrdv_creneaux_info')) {
            ...
            // $methodTitle .= ' '.__('between %1 andfresh %2',$_dateRdvStart->format('H:i'),$_dateRdvEnd->format('H:i'));
        }
        return $methodTitle;
    }
}