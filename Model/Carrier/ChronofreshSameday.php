...
class ChronofreshSameday extends AbstractChronopost
{
    /**
     * @var string Chrono Fresh Same Day
     */ 
	
    protected $_code = 'chronofreshsameday';

    const PRODUCT_CODE = '2P';
    ...
    /**
     * ChronofreshSameday constructor.
